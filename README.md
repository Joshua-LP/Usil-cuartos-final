...
- 🏅 **Ranking en Vivo**: Actualización automática de posiciones
...
├── script.js            # Lógica + integración Firebase
├── usil-30.webp         # Logo oficial USIL
...
2. **Completa los 8 pronósticos** de cuartos de final
3. **Guarda tu borrador** o **envía tus pronósticos**
...
[⬆ Volver arriba](#-pollada-mundial-fifa-2026---usil)
